...
class MemoryDiagramConnector implements DiagramConnector {
    ...
    MemoryDiagramConnector(EAConnector.Direction labelDirection, boolean hidden, EAConnector innerConnector, DiagramElement source, DiagramElement target, DiagramElement associationClass) {
