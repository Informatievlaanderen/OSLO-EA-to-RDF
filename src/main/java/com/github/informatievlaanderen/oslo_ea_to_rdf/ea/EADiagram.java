...
/**
 * A class diagram in an Enterprise Architect project. A diagram contains a subset of the elements declared
 * in the project and has specific layout information.
 *
