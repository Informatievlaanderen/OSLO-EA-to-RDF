...
/**
 * A definition of an independent data model. Elements form the basis of Enterprise Architect
 * projects.
 *
 * <p>Three types of elements are discerned: classes, enumerations and datatypes.
 *
    ...
    public static Type parse(String eaString) {
      switch (eaString) {
        ...
        case "Enumeration":
          return ENUMERATION;
        default:
          throw new IllegalArgumentException("Invalid element type: " + eaString);
      }
    }
  }
}
